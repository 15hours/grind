...
class Solution:
    ...
    def _bfs_approach(self, graph: list[list[int]]) -> list[list[int]]:
    ...
    def _dfs_approach(self, graph: list[list[int]]) -> list[list[int]]:
        all_paths = []
        target = len(graph) - 1
    ...
    def _dp_solution(self, graph: list[list[int]]) -> list[list[int]]:
        target = len(graph) - 1
    ...
    def all_paths_source_target(self, 
                                graph: list[list[int]]
                                ) -> list[list[int]]:
        # return self._bfs_approach(graph)
        # return self._dfs_approach(graph)
        return self._dp_solution(graph)

    def allPathsSourceTarget(self, graph: list[list[int]]) -> list[list[int]]:
        return self.all_paths_source_target(graph)


sol = Solution()
print(sol.all_paths_source_target([[2],[],[1]]))
print(sol.all_paths_source_target([[4,3,1],[3,2,4],[3],[4],[]]))
