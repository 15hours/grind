...
class Solution:
    ...
    def min_reorder(self, 
                    n: int, 
                    connections: list[list[int]]
                    ) -> int:
        # return self._bfs_approach(n, connections)
        return self._dfs_approach(n, connections)


sol = Solution()
n = 5
connections = [[1,0],[1,2],[3,2],[3,4]]
print(sol.min_reorder(n, connections))
print(sol.min_reorder(6, [[0,1],[1,3],[2,3],[4,0],[4,5]]))
print(sol.min_reorder(10, [[0,1],[2,0],[0,3],[3,4],[5,0],
                      [1,6],[2,7],[8,1],[3,9]]))
print(sol.min_reorder(6, [[0,2],[0,3],[4,1],[4,5],[5,0]]))