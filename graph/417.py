...
class Solution:
    ...
    def _bfs_approach(self, heights: list) -> list[list[int]]:
    ...
    def _dfs_approach(self, heights: list[list[int]]) -> list[list[int]]:
        num_rows = len(heights)
        num_cols = len(heights[0])
    ...
    def pacific_atlantic(self, heights: list[list[int]]) -> list[list[int]]:
        # return self._bfs_approach(heights)
        return self._dfs_approach(heights)
