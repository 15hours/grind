...
class Solution:
    ...
    def shortest_alternating_paths(self, 
                                   n: int, 
                                   red_edges: list[list[int]], 
                                   blue_edges: list[list[int]]
                                   ) -> list[int]:
        return self._bfs_approach(n, red_edges, blue_edges)  
    

sol = Solution()
print(sol.shortest_alternating_paths(3, [[0,1],[0,2]], [[1,0]]))
red_edges = [[0,1],[3,2],[1,0],[4,3],[2,4]]
blue_edges = [[2,4],[2,2],[1,3]]
print(sol.shortest_alternating_paths(5, red_edges, blue_edges))
red_edges = [[0,1],[1,2],[2,3],[3,4]]
blue_edges = [[1,2],[2,3],[3,1]]
print(sol.shortest_alternating_paths(5, red_edges, blue_edges))
red_edges = [[5,5],[4,6],[6,4],[4,1],[4,3],[2,3],
            [1,1],[1,6],[0,6],[0,2],[1,5],[6,0]]
blue_edges = [[1,1],[5,2],[4,0],[5,5],[2,4],[4,2],[0,4],
             [0,5],[3,5],[1,2],[6,2],[0,6],[3,1],[5,0]]
print(sol.shortest_alternating_paths(7, red_edges, blue_edges))