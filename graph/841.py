...
class Solution:
    ...
    def _dfs_approach(self, rooms: list[list[int]]) -> bool:
    ...
    def can_visit_all_nodes(self, rooms: list[list[int]]) -> bool:
        return self._dfs_approach(rooms)


sol = Solution()
print(sol.can_visit_all_nodes([[1],[2],[3],[]]))
print(sol.can_visit_all_nodes([[1,3],[3,0,1],[2],[0]]))