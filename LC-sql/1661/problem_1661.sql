...
same number of processes. Write a solution to find the average time each
...
Machine 0's average time is ((1.520 - 0.712) + (4.120 - 3.140)) / 2 =
0.894
Machine 1's average time is ((1.550 - 0.550) + (1.420 - 0.430)) / 2 =
0.995
