...
class Solution:
    ...
    def dsu_approach(self, accounts: list[list[str]]) -> list[list[str]]:
        print("[DSU]")
    ...
    def dfs_approach(self, accounts: list[list[str]]) -> list[list[str]]:
        print("[DFS]")
        ...
        def dfs(acc_id: int, nodes: set[int]) -> None:
            if visited[acc_id]:
                return
